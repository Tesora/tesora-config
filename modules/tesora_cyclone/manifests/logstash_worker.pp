...
class tesora_cyclone::logstash_worker (
  ...
  file { '/etc/default/logstash-indexer':
    ...
    group  => 'root',
    mode   => '0644',
    source => 'puppet:///modules/tesora_cyclone/logstash/logstash-indexer.default',
  }

  class { 'logstash::indexer':
    conf_template => 'tesora_cyclone/logstash/indexer.conf.erb',
  }

  include log_processor
  log_processor::worker { 'A':
    config_file => 'puppet:///modules/tesora_cyclone/logstash/jenkins-log-worker.yaml',
  }
