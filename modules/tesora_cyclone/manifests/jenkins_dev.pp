...
class tesora_cyclone::jenkins_dev (
  ...
  class { '::jenkins::master':
    ...
    jenkins_ssh_public_key  => $tesora_cyclone::jenkins_dev_ssh_key,
  }
...
#  }
  ...
  file { '/etc/default/jenkins':
    ...
    group  => 'root',
    mode   => '0644',
    source => 'puppet:///modules/tesora_cyclone/jenkins/jenkins.default',
  }
  ...
  class { '::nodepool':
    ...
    environment              => {
      'NODEPOOL_SSH_KEY'     => $tesora_cyclone::jenkins_dev_ssh_key,
    }
  }
  ...
  file { '/etc/nodepool/scripts':
    ...
    source  => 'puppet:///modules/tesora_cyclone/nodepool/scripts',
  }
