...
#
# Common configuration between tesora_cyclone::slave and
# tesora_cyclone::single_use_slave
class tesora_cyclone::slave_common(
  $include_pypy = false,
  $sudo         = false,
  ...
  file { '/home/jenkins/.pydistutils.cfg':
    ...
    group   => 'jenkins',
    mode    => '0644',
    source  => 'puppet:///modules/tesora_cyclone/pydistutils.cfg',
  ...
  file { '/home/jenkins/.pip/pip.conf':
    ...
    group   => 'jenkins',
    mode    => '0644',
    source  => 'puppet:///modules/tesora_cyclone/pip.conf',
    require => Class['jenkins::slave'],
  }
  ...
  if ($sudo == true) {
    file { '/etc/sudoers.d/jenkins-sudo':
      ...
      source => 'puppet:///modules/tesora_cyclone/jenkins-sudo.sudo',
      owner  => 'root',
      group  => 'root',
      mode   => '0440',
    }
  ...
  file { '/etc/sudoers.d/jenkins-sudo-grep':
    ...
    source => 'puppet:///modules/tesora_cyclone/jenkins-sudo-grep.sudo',
    owner  => 'root',
    group  => 'root',
    mode   => '0440',
  }
