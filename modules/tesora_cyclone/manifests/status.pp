...
class tesora_cyclone::status (
  ...
  apache::vhost { 'status.openstack.org':
    ...
    template => 'tesora_cyclone/status.vhost.erb',
  ...
  file { '/srv/static/status/index.html':
    ...
    source  => 'puppet:///modules/tesora_cyclone/status/index.html',
    require => File['/srv/static/status'],
  }

  file { '/srv/static/status/favicon.ico':
    ensure  => present,
    source  => 'puppet:///modules/tesora_cyclone/status/favicon.ico',
    require => File['/srv/static/status'],
  }

  file { '/srv/static/status/common.js':
    ensure  => present,
    source  => 'puppet:///modules/tesora_cyclone/status/common.js',
    require => File['/srv/static/status'],
  }
  ...
  file { '/srv/static/status/zuul/index.html':
    ...
    source  => 'puppet:///modules/tesora_cyclone/zuul/status.html',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/status.js':
    ensure  => present,
    source  => 'puppet:///modules/tesora_cyclone/zuul/status.js',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/green.png':
    ensure  => present,
    source  => 'puppet:///modules/tesora_cyclone/zuul/green.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/red.png':
    ensure  => present,
    source  => 'puppet:///modules/tesora_cyclone/zuul/red.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/black.png':
    ensure  => present,
    source  => 'puppet:///modules/tesora_cyclone/zuul/black.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/grey.png':
    ensure  => present,
    source  => 'puppet:///modules/tesora_cyclone/zuul/grey.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/line-angle.png':
    ensure  => present,
    source  => 'puppet:///modules/tesora_cyclone/zuul/line-angle.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/line-t.png':
    ensure  => present,
    source  => 'puppet:///modules/tesora_cyclone/zuul/line-t.png',
    require => File['/srv/static/status/zuul'],
  }

  file { '/srv/static/status/zuul/line.png':
    ensure  => present,
    source  => 'puppet:///modules/tesora_cyclone/zuul/line.png',
    require => File['/srv/static/status/zuul'],
  }
