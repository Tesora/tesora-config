...
class tesora_cyclone::git_backend (
  ...
  file { '/etc/cgitrc':
    ...
    group   => 'root',
    mode    => '0644',
    source  => 'puppet:///modules/tesora_cyclone/git/cgitrc'
  }
  ...
  file { '/var/www/cgit/static/openstack.css':
    ...
    source  => 'puppet:///modules/tesora_cyclone/git/openstack.css',
    require => File['/var/www/cgit/static'],
  }
  ...
  file { '/usr/local/bin/commit-filter.sh':
    ...
    group   => 'root',
    mode    => '0755',
    source  => 'puppet:///modules/tesora_cyclone/git/commit-filter.sh',
  }
